...
/* strlens; 256= FILE_MAXFILE, 160= FILE_MAXDIR */
...
typedef struct Sequence {
	...
	char name[256]; /* SEQ_NAME_MAXSTR - name, set by default and needs to be unique, for RNA paths */
