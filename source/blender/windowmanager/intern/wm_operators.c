...
static uiBlock *wm_block_create_splash(bContext *C, ARegion *ar, void *UNUSED(arg))
{
	...
	BLI_snprintf(version_str, sizeof(version_str),
	             "Graphicall build %d.%02d.%d", BLENDER_VERSION/100, BLENDER_VERSION%100, BLENDER_SUBVERSION);
	BLI_snprintf(revision_str, sizeof(revision_str), "by sambler  r%s", build_rev);
